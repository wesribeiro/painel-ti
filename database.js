...
// ... existing code ...
  ...
  // ... Tabela pdvs ...
  db.run(`CREATE TABLE IF NOT EXISTS pdvs (
// ... existing code ...
        FOREIGN KEY(store_id) REFERENCES stores(id)
    )`);

  // ... Tabela status_types ...
  db.run(`CREATE TABLE IF NOT EXISTS status_types (
// ... existing code ...
        color TEXT NOT NULL
    )`);
...
// ... existing code ...
  ...
  // Tabela de Incidentes (Problemas)
  ...
  // Tabela de Movimentação de Ativos (ITAM)
